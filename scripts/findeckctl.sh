...
UID_NUM="$(id -u)"
DOMAIN="gui/$UID_NUM"
SERVER_LABEL="$DOMAIN/dev.findeck.server"
WEB_LABEL="$DOMAIN/dev.findeck.web"
SERVER_PLIST="$HOME/Library/LaunchAgents/dev.findeck.server.plist"
WEB_PLIST="$HOME/Library/LaunchAgents/dev.findeck.web.plist"
